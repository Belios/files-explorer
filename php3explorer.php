...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    if($file == $cur) {
    echo "<img src=\"images/dir-open.png\" /> $entry<br />\n";
    } else {
    echo
    "  <img src=\"images/dir.png\" /> <a href=\"$_SERVER[PHP_SELF]?dir=".
    ...
    echo '<tr><td><img src="images/dir.png" /> '.$elem['name'].
    '</td><td> </td>
    <td> </td><td>  </td>
    ...
    echo '<tr><td><img src="images/file-none.png" /> '.$elem['name'].
    '</td><td> </td>
    ...
    /* lien sur la racine */
    if(!$dir) {
    echo "<img src=\"images/dir-open.png\" /> /<br />\n";
    } else {
    echo
    "<img src=\"images/dir.png\" /> <a href=\"".$_SERVER['PHP_SELF'].
    "\">/</a><br" .
    " />\n";
    }
